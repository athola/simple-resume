...
def test_generate_hcl_palette_deterministic(story: Scenario) -> None:
...
def test_generate_hcl_palette_positive_size(story: Scenario) -> None:
...
def test_generate_hcl_palette_respects_size(story: Scenario) -> None:
