...
class TestLazyWrapperFunctions:
    ...
    @patch("simple_resume.shell.runtime.lazy._lazy_core")
    def test_generate_pdf_delegates_to_core(self, mock_core: MagicMock) -> None:
    ...
    @patch("simple_resume.shell.runtime.lazy._lazy_core")
    def test_generate_html_delegates_to_core(self, mock_core: MagicMock) -> None:
    ...
    @patch("simple_resume.shell.runtime.lazy._lazy_core")
    def test_generate_all_delegates_to_core(self, mock_core: MagicMock) -> None:
    ...
    @patch("simple_resume.shell.runtime.lazy._lazy_core")
    def test_generate_resume_delegates_to_core(self, mock_core: MagicMock) -> None:
    ...
    @patch("simple_resume.shell.runtime.lazy._lazy_core")
    def test_generate_delegates_to_core(self, mock_core: MagicMock) -> None:
    ...
    @patch("simple_resume.shell.runtime.lazy._lazy_core")
    def test_preview_delegates_to_core(self, mock_core: MagicMock) -> None:
