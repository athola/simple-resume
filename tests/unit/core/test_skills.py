...
class TestFormatSkillGroups:
    ...
    def test_simple_string_input(self) -> None:
    ...
    def test_dict_with_categories(self) -> None:
    ...
    def test_list_with_dict_entries(self) -> None:
    ...
    def test_list_with_mixed_content(self) -> None:
