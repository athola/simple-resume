...
validate: validate-readme-preview ## Validate current commit is ready for PR
	...
	$(UV_CMD) run python -c "import $(PROJECT_MODULE); print('  [OK] $(PROJECT_MODULE) imports correctly')"
	$(UV_CMD) run python -c "from $(PROJECT_MODULE) import generate; print('  [OK] generate function imports correctly')"
